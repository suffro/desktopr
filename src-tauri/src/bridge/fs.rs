...
#[tauri::command]
pub fn fs_list_dir(app: AppHandle, rel: String, permanent: bool) -> Result<Vec<FsEntry>, String> {
...
#[tauri::command]
pub fn fs_mkdir(app: AppHandle, rel: String, permanent: bool) -> Result<(), String> {
    let dir = resolve_any(&app, &rel, permanent)?;
    fs::create_dir_all(&dir).map_err(|e| e.to_string())
}

#[tauri::command]
pub fn fs_rm(app: AppHandle, rel: String, permanent: bool, recursive: bool) -> Result<(), String> {
...
#[tauri::command]
pub fn fs_stat(app: AppHandle, rel: String, permanent: bool) -> Result<FsEntry, String> {
...
#[tauri::command]
pub fn fs_clear_cache(app: AppHandle) -> Result<(), String> {
...
#[tauri::command]
pub fn fs_paths(app: AppHandle) -> Result<FsPaths, String> {
