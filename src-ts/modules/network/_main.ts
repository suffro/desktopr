...
export function buildNetwork(core: { invoke: BubbledeskAPI["invoke"] }): NetworkInterface {
  return {
    ...
    ping: (url?: string, timeoutMs?: U64): Promise<void> => core.invoke("bd_network_ping", {url, timeoutMs}),
    resolve: (host: string): Promise<void> => core.invoke("bd_network_resolve", {host}),
    estimateBandwidth: (url?: string, sizeHintBytes?: U64, timeoutMs?: U64): Promise<void> => core.invoke("bd_network_bandwidth_estimate", {url, size_hint_bytes: sizeHintBytes, timeoutMs}),
