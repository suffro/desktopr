...
function buildDiagnostics(core) {
    return {
        ...
        newError: {
            js: (payload) => core.invoke("bd_logs_record_js_error", { payload, appVersion: _constants_1.APP_VERSION }),
            native: (payload) => core.invoke("bd_logs_record_native_error", { payload, appVersion: _constants_1.APP_VERSION }),
            // Rust richiede 'env' obbligatorio: di default "generic" se non passato
            generic: (payload, env = "generic") => core.invoke("bd_logs_record_error", { payload, appVersion: _constants_1.APP_VERSION, env }),
        },
